      ...
      <div className="flex flex-col lg:flex-row lg:justify-between">
        ...
        <div className="lg:flex lg:flex-col lg:w-[calc(50%-10px)]">
          ...
          <div className="leading-[26px] flex flex-col gap-[40px] items-end lg:gap-[30px]">
            <p className="self-start text-[clamp(20px,4.5vw,30px)] leading-[clamp(26px,5.5vw,2.7rem)] max-[491px]:max-w-[300px] min-[900px]:max-w-[750px] lg:text-[26px] lg:ml-10 lg:leading-[36px] lg:font-light-font-weight">
