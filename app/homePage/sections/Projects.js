...
export default function Projects() {
  ...
  useEffect(() => {
    ...
    imageList.forEach(({ key, src }) => {
      ...
      img.src = src;
      img.onload = () => {
        // duży obraz już w cache, możemy go natychmiast pokazać
        setLoadedImages((prev) => ({ ...prev, [key]: true }));
        // małe opóźnienie, aby upewnić się że jest w DOM przed fade-in
      ...
      {loadedImages[key] && (
        <img
          ...
          className={`absolute top-0 left-0 w-full h-full object-cover ${
            fadeInImages[key] ? "opacity-100" : "opacity-50"
          }`}
          style={{
            transition: "opacity 0s", // brak duration — zmiana natychmiastowa
          }}
        />
      )}
    </div>
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between">
        <div className="flex flex-col lg:w-[calc(50%-10px)]">
          ...
          <div className="max-w-[80%] mb-[50px] lg:mb-[30px] lg:max-w-[100%]">
            ...
            <div className="flex justify-between mt-[5px] text-[clamp(12px,3.35vw,1rem)] font-normal-font-weight">
          ...
          {/* Projekt 4 */}
          <div className="w-[86%] flex flex-col items-end self-end mb-[50px] lg:mb-0 lg:w-full lg:h-full">
            <div className="relative aspect-5/3 lg:h-full">
              {renderProjectImage(
                "/projekt4-small.jpg",
                "/projekt4-large.jpg",
                "projekt4"
            ...
            <div className="flex justify-between mt-[5px] text-[clamp(12px,3.35vw,1rem)]">
              <span>Our project</span>
              <span>View project</span>
            </div>
          </div>
        ...
        <div className="lg:flex lg:flex-col lg:w-[calc(50%-10px)]">
          ...
          {/* Projekt 1 */}
          <div className="max-w-[78%] mb-[30px] lg:w-full lg:max-w-full lg:mb-[60px]">
          ...
          <div className="leading-[26px] flex flex-col gap-[40px] items-end lg:gap-[30px]">
            ...
            <button className="bg-main-black rounded-buttonWithArrow-rounded px-buttonWithArrow-padding-x py-buttonWithArrow-padding-y text-main-white ml-buttonWithArrow-margin-left-mobile mr-buttonWithArrow-margin-right-mobile font-medium flex items-center md:ml-buttonWithArrow-margin-left-tablet text-hero-text-size-mobile">
              ...
              <Image
                src={ArrowWhite}
                alt="strzałka"
                className="w-buttonWithArrow-icon-width h-buttonWithArrow-icon-height relative top-[0.5px]"
              />
            </button>
          </div>
        </div>
